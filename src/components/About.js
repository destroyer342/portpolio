...
export default function About() {
  useEffect(() => {
    document.title = "Rance Cañete | About Me ";
    ...
    <>
      <div className="container home-page">
        ...
        <div className="text-zone">
          ...
          <p align="LEFT">
            A skilled and knowledgeable computer engineering student with extensive
            ...
            debugger and,
            <br />
            a fan of "HIMYM", Outdoor Sports, TV series, Music, and
            recently, Gaming.
            <br />
            <br />
